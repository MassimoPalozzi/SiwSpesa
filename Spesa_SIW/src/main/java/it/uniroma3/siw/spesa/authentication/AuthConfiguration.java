package it.uniroma3.siw.spesa.authentication;
...
import static it.uniroma3.siw.spesa.model.Credential.ADMIN_ROLE;
import static it.uniroma3.siw.spesa.model.Credential.VIP_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                // solo gli utenti autenticati con ruolo ADMIN o VIP possono accedere a risorse con patch /admin/**
                .antMatchers(HttpMethod.GET, "/vip/**").hasAnyAuthority(ADMIN_ROLE)
                .antMatchers(HttpMethod.POST, "/vip/**").hasAnyAuthority(ADMIN_ROLE)
                .antMatchers(HttpMethod.GET, "/vip/**").hasAnyAuthority(VIP_ROLE)
                .antMatchers(HttpMethod.POST, "/vip/**").hasAnyAuthority(VIP_ROLE)
